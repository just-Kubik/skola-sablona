						...
						<!-- One -->
							<section id="one" class="tiles">
								<article>
									...
									<header class="major">
										<h3><a href="krajinky.html" class="link">Krajinky</a></h3>
								...
								<article>
									...
									<header class="major">
										<h3><a href="nocnifotografie.html" class="link">Noční fotografie</a></h3>
								...
								<article>
									...
									<header class="major">
										<h3><a href="dronovky.html" class="link">Dronovky</a></h3>
								...
								<article>
									...
									<header class="major">
										<h3><a href="portrety.html" class="link">Portréty</a></h3>
								...
								<article>
									...
									<header class="major">
										<h3><a href="me.html" class="link">O mně</a></h3>
										<p>Ipsum dolor sit amet</p>
									</header>
								</article>
								<article>
									...
									<header class="major">
										<h3><a href="ostatni.html" class="link">Ostatní fotografie</a></h3>
										<p>Feugiat amet tempus</p>
									</header>
								</article>
							</section>

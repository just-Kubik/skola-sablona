			...
			<div id="wrapper">
				...
				<!-- Note: The "styleN" class below should match that of the header element. -->
					<section id="banner" class="style2">
						<div class="inner">
							<span class="image">
								<img src="images/portrety/pic07.jpg" alt="" />
							</span>
							<header class="major">
								<h1>Portréty</h1>
							</header>
								...
								<section>
									...
									<div class="content">
										<div class="inner">
											...
											<p>Nullam et orci eu  efficitu consequat tincidunt. Vivamus et sagittis tempus.</p>
											<ul class="actions">
											</ul>
										</div>
									</div>
								...
								<section>
									...
									<div class="content">
										<div class="inner">
											...
											<p>Nullam et orci eu lorem. Vivamus et sagittis tempus.</p>
											<ul class="actions">
											</ul>
										</div>
									</div>
								...
								<section>
									...
									<div class="content">
										<div class="inner">
											...
											<p>Nullam et orci eu lorem consequ tis tempus.</p>
											<ul class="actions">
											</ul>
										</div>
									</div>
								...
								<section>
									...
									<div class="content">
										<div class="inner">
											...
											<p>Nullam et orci eu lorem consequat tincidunt vivamus e</p>
											<ul class="actions">
											</ul>
										</div>
									</div>
